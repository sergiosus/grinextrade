      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          ...
          <a
            ...
            className="inline-flex items-center justify-center w-12 h-12 bg-[#25D366] text-white font-medium rounded-xl hover:opacity-90 shadow-lg transition"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center w-12 h-12 bg-[#0088cc] text-white font-medium rounded-xl hover:opacity-90 shadow-lg transition"
